...
C="--cliques --cq-wall --cq-interior --cq-max 500 --cq-age 3 --row-age 3 --pose-max 3500 --threads 1 --rowloops 8 --stages 4 --row-cap 6000"
N=${N:-4}
S=${S:-450}
...
nohup sh search/t4screen_loop.sh 3.98 V98 $N $S --corners 1111 --patterns "........" \
    ...
    --cliques --cq-interior --cq-max 500 --cq-age 3 --row-age 3 --pose-max 3500 --threads 1 --rowloops 8 --stages 4 --row-cap 6000 > runs/V98.out 2>&1 &
echo "launched 7"
